    ...
    <>
      <main>
        ...
        >
          ...
          si corecte. GhidulParintelui economiseste ore de cautari si transforma haosul inscrierilor 
        ...
        <Section
          id="despre-noi"
          label="Despre Noi"
          title="In cautarea sensului si a frumosului."
        >
        ...
        <div id="evenimente">
          <Section
            label="Events"
            title="Initiativele frumoase ies mai bine impreuna."
          >
        ...
        dangerouslySetInnerHTML={{
          __html: `
            (function(){
              ...
              chatbaseScript.id = "TNb8Hr9CVXpZ-SGouZCc6";
              chatbaseScript.setAttribute("data-chatbot-id", "TNb8Hr9CVXpZ-SGouZCc6");
              chatbaseScript.setAttribute("data-domain", "www.chatbase.co");
              chatbaseScript.async = true;
              chatbaseScript.defer = true;
              
              if (document.readyState === "loading") {
                document.addEventListener("DOMContentLoaded", function() {
                  if (!document.getElementById("TNb8Hr9CVXpZ-SGouZCc6")) {
